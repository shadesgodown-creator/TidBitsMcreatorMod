...
public class TidBitSwordBladeItem extends RandomTidsAndBitsModElements.ModElement {
	@ObjectHolder("random_tids_and_bits:tid_bit_sword_blade")
	public static final Item block = null;
	public TidBitSwordBladeItem(RandomTidsAndBitsModElements instance) {
		super(instance, 17);
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tid_bit_sword_blade");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Tid Bit Sword Blade");
					}
