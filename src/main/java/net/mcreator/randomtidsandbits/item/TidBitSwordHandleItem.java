...
import net.mcreator.randomtidsandbits.gui.ToolMakerGui;
...
public class TidBitSwordHandleItem extends RandomTidsAndBitsModElements.ModElement {
	@ObjectHolder("random_tids_and_bits:tid_bit_sword_handle")
	public static final Item block = null;
	public TidBitSwordHandleItem(RandomTidsAndBitsModElements instance) {
		super(instance, 18);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof ToolMakerGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(TidsandBitsItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("tid_bit_sword_handle");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Tid Bit Sword Handle");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new ToolMakerGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
